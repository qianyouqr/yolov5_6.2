...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='G:\\PeasantIdentity\\yolov5_6.2', help='dataset path')
    #parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5s-cls.pt', help='model.pt path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'result/exp4/weights/best.pt', help='model.pt path(s)')
