...
def parse_opt(known=False):
    ...
    parser.add_argument('--model', type=str, default='classify/yolov5x-cls.pt', help='initial weights path')
    parser.add_argument('--data', type=str, default='G:\\PeasantIdentity\\yolov5_6.2', help='cifar10, cifar100, mnist, imagenet, etc.')
    ...
    parser.add_argument('--project', default='result', help='save to project/name')
